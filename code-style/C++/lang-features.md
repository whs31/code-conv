...
Про наиболее распостраненное использование `constinit` можно прочитать здесь: [[C++/scoping#Статические и локальные для потока переменные|Статические и локальные для потока переменные]]
...
#### Далее: [[C++/naming|Соглашение по именованию]]