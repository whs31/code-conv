...
- [[#Стандарт C++|Стандарт C++]]
- [[#Компилятор|Компилятор]]
- [[#Нестандартные расширения компилятора|Нестандартные расширения компилятора]]
	- [[#Нестандартные расширения компилятора#Атрибуты GCC|Атрибуты GCC]]
		- [[#Атрибуты GCC#Как заменить `__attribute__((constuctor))`?|Как заменить `__attribute__((constuctor))`?]]
			- [[#Как заменить `__attribute__((constuctor))`?#Неправильный код|Неправильный код]]
			- [[#Как заменить `__attribute__((constuctor))`?#Правильный код|Правильный код]]
		- [[#Атрибуты GCC#Как заменить `__attribute__((packed))`?|Как заменить `__attribute__((packed))`?]]
			- [[#Как заменить `__attribute__((packed))`?#Неправильный код|Неправильный код]]
			- [[#Как заменить `__attribute__((packed))`?#Правильный код|Правильный код]]
	- [[#Нестандартные расширения компилятора#Встроенные функции компиляторов (*интринсики*)|Встроенные функции компиляторов (*интринсики*)]]
		- [[#Встроенные функции компиляторов (*интринсики*)#Если необходимо использование интринсика|Если необходимо использование интринсика]]
			- [[#Если необходимо использование интринсика#Неправильный код|Неправильный код]]
			- [[#Если необходимо использование интринсика#Правильный код|Правильный код]]
		- [[#Встроенные функции компиляторов (*интринсики*)#Если интринсик нужен для импорта/экспорта в динамической библиотеке|Если интринсик нужен для импорта/экспорта в динамической библиотеке]]
	- [[#Нестандартные расширения компилятора#Особые директивы препроцессора|Особые директивы препроцессора]]
	- [[#Нестандартные расширения компилятора#Прочие нестандартные расширения языка|Прочие нестандартные расширения языка]]
